# Run Manifest: study-2026-08-16-eth15m-volfiltered-momentum

> Completed after the run. This manifest does not authorize live trading.

## Identity

- run id: `run-2026-08-16-eth15m-volfiltered-momentum-1`
...
- command line: `./scripts/gmaq-research-backtest --rule momentum`
...
- result metrics summary: train 913 trades
  -26.2% (Sharpe -22.0039); OOS
  405 trades -11.4%
  (Sharpe -23.7021); OOS stress -23.9%;
  benchmark 5.0% gross.

## Conclusion

- verdict: REJECT
- exact gate rule that fired: OOS Sharpe -23.7021 < 0.5 AND OOS
  stress net return -23.9% not > 0

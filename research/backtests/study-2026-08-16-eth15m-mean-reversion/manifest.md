# Run Manifest: study-2026-08-16-eth15m-mean-reversion

> Completed after the run. This manifest does not authorize live trading.

## Identity

- run id: `run-2026-08-16-eth15m-mean-reversion-1`
...
- command line: `./scripts/gmaq-research-backtest --rule reversion`
...
- result metrics summary: train 1624 trades
  -45.4% (Sharpe -29.8916); OOS
  715 trades -19.9%
  (Sharpe -35.9161); OOS stress -42.0%;
  benchmark 5.2% gross.

## Conclusion

- verdict: REJECT
- exact gate rule that fired: OOS Sharpe -35.9161 < 0.5 AND OOS
  stress net return -42.0% not > 0

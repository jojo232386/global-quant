# Run Manifest: study-2026-08-16-multi-funding-crosssection

> Completed after the run. This manifest does not authorize live trading.

## Identity

- run id: `run-2026-08-16-funding_crosssection-1`
...
- command line: `./scripts/gmaq-research-crosssection --rule funding_crosssection`
...
- result metrics summary: train 312 trades
  4.9%; OOS 183 trades
  13.1% (Sharpe 1.662);
  OOS stress 7.4%;

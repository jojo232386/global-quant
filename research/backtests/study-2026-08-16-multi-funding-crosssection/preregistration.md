# Hypothesis Preregistration: USD-M funding-rate cross-section (long low-funding)
...
- title: USD-M funding-rate cross-section (long low-funding)
- author / session: gmaq continuation session
- date (UTC): 2026-08-16

## 2. Hypothesis (required)

- Investible claim: among the top-15 USD-M perpetuals, a daily-rebalanced long of the 3 symbols with the lowest trailing 24h average funding rate earns a positive return after conservative costs.
- Mechanism: persistently negative funding marks crowded shorts; spot buying pressure follows as carry converges.
...
- signal (at 23:45 close T): mean funding rate over funding records with fundingTime <= T, using up to the last 3 records per symbol
- rank symbols ascending by that mean; long the 3 lowest

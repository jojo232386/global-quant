# Hypothesis Preregistration: PIT funding-rate cross-section (long low-funding)
...
- title: PIT funding-rate cross-section (long low-funding)
- author / session: gmaq continuation session
- date (UTC): 2026-08-17

## 2. Hypothesis (required)

- Investible claim: with a point-in-time top-15 universe, a daily-rebalanced long of the 3 lowest trailing-24h mean funding rate symbols earns a positive return after conservative costs.
- Mechanism: crowded shorts (negative funding) mean-revert into spot buying pressure.
...
- rule: PIT funding-rate cross-section (long low-funding)

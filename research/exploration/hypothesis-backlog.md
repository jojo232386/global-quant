...
- `EXPL-017-IMPL-001`, `EXPL-017-IMPL-002`, and `EXPL-017-IMPL-003` are
  `INVALID_PRE_FORMAL`: implementation defects invalidated those attempts
  only. `EXPL-017-IMPL-004` is the clean attempt. All have
...
9. EXPL-017: PRE_FORMAL_ACTIVE under clean implementation attempt
   EXPL-017-IMPL-004; no market verdict or Factor Graveyard entry.
